---
title: "Agent 的分工：一文讲透 Multi-Agent"
source: "https://mp.weixin.qq.com/s/lwj_rgbdPt3IxTx6SUmS2Q"
author:
  - "[[二曲线工程师]]"
published:
created: 2026-06-30
description: "Agent 工程系列第 9 篇： Multi-Agent"
tags:
  - "clippings"
---
二曲线工程师 工程师的第二曲线 *2026年6月10日 18:03*
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/xmGIAYiaJQ2icBbKhdO0zbKTIQNx7Jr2kqcv0n8xibJiaMqFNEWUkubicSZTrRKzOJMJ0Aq5lYEVGHMiblfPQmibHwVzUNCCnTZlCmvUxDUrEp0prc/640?wx_fmt=png&from=appmsg&watermark=1#imgIndex=0)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/xmGIAYiaJQ290g0YiapBibjicMXMtRWapfflG28OZgqian4E3DibmFz8gr5Thr8kFs01RibooId2Pnlazj6joiboicvgrAuTLaIMGclH45vDJoyLibXvQ/640?wx_fmt=png&from=appmsg&watermark=1#imgIndex=1)
...
下一篇，我们来聊 Planning——它是 Agent 从"能完成简单任务"到"能处理复杂问题"的关键跨越。

**参考资料**

1. LangGraph 官方文档 — Multi-Agent 架构设计：https://langchain-ai.github.io/langgraph/concepts/multi\_agent/ ( https://langchain-ai.github.io/langgraph/concepts/multi\_agent/ )
2. AutoGen 0.4 架构介绍：https://microsoft.github.io/autogen/stable/user-guide/core-user-guide/index.html ( https://microsoft.github.io/autogen/stable/user-guide/core-user-guide/index.html )
3. CrewAI 官方文档：https://docs.crewai.com/introduction ( https://docs.crewai.com/introduction )
4. OpenAI Agents SDK 文档：https://openai.github.io/openai-agents-python/ ( https://openai.github.io/openai-agents-python/ )
5. OpenAI Agents SDK Tracing：https://github.com/openai/openai-agents-python/blob/main/docs/tracing.md ( https://github.com/openai/openai-agents-python/blob/main/docs/tracing.md )
6. Google ADK 官方文档：https://google.github.io/adk-docs/ ( https://google.github.io/adk-docs/ )
7. Anthropic：Building effective agents（Multi-agent systems 章节）：https://www.anthropic.com/research/building-effective-agents ( https://www.anthropic.com/research/building-effective-agents )

#Agent开发 #大模型应用 #AI工程师 #后端开发 #MultiAgent #多智能体
